...
public class PedidoView {
    ...
    public void listarPedidosPorCpfCnpjCliente() {
        List<Cliente> clientes = new ArrayList<>();
        List<Pedido> pedidos = new ArrayList<>();
        ...
        String cidade = FerramentaView.sc.nextLine();
        System.out.println("------------------------------------------------------------");
    ...
    public void listarPedidosPendentesEstado() {
        List<Pedido> pedidos = new ArrayList<>();

        System.out.println("\n\n------------------------------------------------------------");
        System.out.println("• Digite o estado do Brasil que deseja procurar (ex: SC, SP): ");
        String estado = FerramentaView.sc.nextLine();
        System.out.println("------------------------------------------------------------");
