...
public class MenuLogistica {
    ...
    public static MotoristaView motoristaView = new MotoristaView();
    public static PedidoView pedidoView = new PedidoView();
    public static EntregaView entregaView = new EntregaView();
    public static HistoricoEntregaView historicoEntregaView = new HistoricoEntregaView()
