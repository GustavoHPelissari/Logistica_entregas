...
public class PedidoService {
    ...
    public List<Pedido> listarPedidos(){
        ...
        try{
            ...
            throw new RuntimeException("Erro ao listar pedidos: "+e.getStackTrace());
        }
        return pedidos;
    }
    ...
    public void atualizarPedido(Pedido pedido){
        ...
        try{
            ...
            throw new RuntimeException("Erro ao atualizar pedido: "+e.getStackTrace());
        }
    }
    ...
    public void excluirPedido(Integer id){
        try{
            ...
            throw new RuntimeException("Erro ao deletar pedido:" +e.getStackTrace());
        }
    }
